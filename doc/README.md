...
## [2. Pruned LIF model and Binary synaptic weights](#contents)
...
$$S_{current} = S_{previous} + V_{valid} - V_{leakage}$$
...
$$P_{LTD} = 1024 \times \frac{\Delta w}{w_{sum}} \\
